...
///
/// These files are generated by depmod and must be present in the
/// kernel modules directory for modprobe to function correctly.
pub const MODULE_METADATA_FILES: &[&str] = &[
    "modules.dep",
    "modules.dep.bin",
    "modules.alias",
    "modules.alias.bin",
