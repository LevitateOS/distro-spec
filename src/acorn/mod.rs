...
pub use packages::{
    all_live_packages, bootable_packages, core_packages, daily_driver_packages, ALPINE_KEYS,
    BOOTABLE_PACKAGES, CORE_PACKAGES, DAILY_DRIVER_PACKAGES, LIVE_ISO_PACKAGES,
};
pub use paths::{
    // Helper functions
    ...
    DEFAULT_SHELL,
    DEFAULT_USER_GROUPS,
    // Rootfs constants (EROFS only - no squashfs)
    EROFS_CDROM_PATH,
    EROFS_CHUNK_SIZE,
    EROFS_COMPRESSION,
...
pub use crate::shared::ACORN_KERNEL as KERNEL_SOURCE;
...
pub use crate::shared::{
    ...
    ISO_EFI_DIR, ISO_LIVE_DIR, KERNEL_ISO_PATH, LIVE_OVERLAY_ISO_PATH, MOUNT_LIVE_OVERLAY,
    MOUNT_NEWROOT, MOUNT_OVERLAY, QEMU_CPU_MODE, QEMU_DISK_FILENAME, QEMU_SERIAL_LOG,
